...
const Section3 = () => {
  ...
  return (
    <div className='container-fluid  p-md-5' id="affiliateSection">
    ...
    <div className="row px-md-5" style={{display: 'flex' , alignItems: "center"}}>
        <div className="col-12 col-md-7 py-md-3">
            ...
            {user ?
            <Link to="/account" className='btn px-5 btn-primary fw-bold rounded-pill fs-3 fw-bold mb-5'>Affliate Now</Link>
            :
